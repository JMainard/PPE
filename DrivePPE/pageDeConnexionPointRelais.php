        ...
        <div class="card card-signin my-5">
          <div class="card-body">
            ...
            <form method="POST" class="form-signin" action="">
              ...
              <hr class="my-4">
	<a href="formulairePointRelais.html">
...
if(isset($_POST['id'])&&isset($_POST['pwd']))
	{
		...
		$requete="select prLogin,prMdp,prMailVerif from producteur where prLogin='".$_SESSION['id']."'";
		...
		{
			header('location:pagePointRelais.php');
		}
		else
		{
